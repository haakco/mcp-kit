...
func (*OAuthRefreshToken) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case oauthrefreshtoken.FieldID, oauthrefreshtoken.FieldUserID:
			values[i] = new(sql.NullInt64)
		case oauthrefreshtoken.FieldSessionType, oauthrefreshtoken.FieldSignature, oauthrefreshtoken.FieldClientID, oauthrefreshtoken.FieldRequestID, oauthrefreshtoken.FieldScopes:
			values[i] = new(sql.NullString)
		case oauthrefreshtoken.FieldExpiresAt, oauthrefreshtoken.FieldRequestedAt:
...
func (_m *OAuthRefreshToken) Unwrap() *OAuthRefreshToken {
	...
	if !ok {
		panic("_test: OAuthRefreshToken is not a transactional entity")
	}
