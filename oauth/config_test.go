...
func TestConfigApplyDefaultsUsesLinearStyleAccessLifetime(t *testing.T) {
	cfg := Config{
	...
	if cfg.AccessTokenLifespan != 24*time.Hour {
		t.Fatalf("AccessTokenLifespan = %s, want 24h", cfg.AccessTokenLifespan)
	}
