...
**Status:** Complete and archived 2026-06-21.
...
- `go build ./...` passed.
- `go vet ./...` passed.
- `golangci-lint run --allow-serial-runners --timeout=10m ./...` passed with 0 issues.
- Structural lint (`dupl,gocognit,gocyclo,funlen,nestif`) passed with 0 issues.
- `go test ./... -race -count=1` passed.
- Skills consumed `github.com/haakco/mcp-kit v0.5.8`, released `skills-mcp` `v1.1.21`, and production rolled out `ghcr.io/haakco/skills-mcp:1.1.21` and `ghcr.io/haakco/skills-edge:1.1.21`.
