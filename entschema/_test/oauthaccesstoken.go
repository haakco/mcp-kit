...
func (*OAuthAccessToken) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case oauthaccesstoken.FieldID, oauthaccesstoken.FieldUserID:
			values[i] = new(sql.NullInt64)
		case oauthaccesstoken.FieldSessionType, oauthaccesstoken.FieldSignature, oauthaccesstoken.FieldClientID, oauthaccesstoken.FieldRequestID, oauthaccesstoken.FieldScopes:
			values[i] = new(sql.NullString)
		case oauthaccesstoken.FieldExpiresAt, oauthaccesstoken.FieldRequestedAt:
...
func (_m *OAuthAccessToken) Unwrap() *OAuthAccessToken {
	...
	if !ok {
		panic("_test: OAuthAccessToken is not a transactional entity")
	}
